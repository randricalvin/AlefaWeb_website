...
const Services = () => {
  ...
  return (
    <div id='services' className='services text-2xl justify-start items-center flex flex-col' >
      <span data-aos="zoom-in" className='title-services uppercase text-4xl font-bold font-serif text-[#1B1559]'>
        Mes services
      </span>
      ...
      <div className=''>
        <div className='flex gap-8'>
          ...
          <div data-aos="fade-up" data-aos-anchor-placement="top-bottom" className='flex flex-col items-center justify-center w-1/3 '>
            <div class="max-w-sm p-6 bg-white border border-gray-200  rounded-lg shadow-md dark:bg-gray-800 dark:border-gray-700 font-serif2 hover:duration-300 hover:bg-[#1B1559] hover:text-white">
