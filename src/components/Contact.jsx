...
const Contact = () => {
  ...
  return (
    ...
    <form className='input-form font-serif2'>
        ...
        <div className='page-contact-button flex justify-center my-5'>
          ...
          <button 
            type="submit"
            onSubmit={sendEmail}
            className="text-white bg-[#fd7d28] hover:bg-[#FF6501] hover:transition duration-300 ease-in-out font-bold rounded-full text-sm px-5 py-3 inline-flex justify-center text-center uppercase" 
            value="Send Message">Envoyer
            </button>

            {/* ecrire une condition pour afficher le modal si le formulaire est envoyé */}
