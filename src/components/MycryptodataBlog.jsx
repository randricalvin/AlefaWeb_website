...
const MycryptodataBlog = () => {
  return (
    <div className='mt-16 font-serif'>
        <header className='header-mycryptodata bg-[#201E50] flex items-start justify-center uppercase text-white lg:text-5xl font-bold pt-24 name-blog'> Mycryptodata</header>
      ...
      <div className='font-serif2 text-mycryptodata text-xl text-center lg:pt-80 lg:w-5/6 mx-auto flex flex-col content-blog'>
        ...
        <div className='text-left'>
          ...
          <div className='flex lg:justify-start button-presentation'>
            <a href="https://mycryptodata.netlify.app/" target="_blank" className='text-white lg:w-1/6 button-presentation1 bg-[#fd7d28] hover:bg-[#FF6501] hover:transition duration-300 ease-in-out font-bold rounded-full text-sm px-5 py-3 inline-flex justify-center text-center uppercase font-serif2 my-8'>Visiter le site</a>
          </div>
      </div>
    </div>
  )
